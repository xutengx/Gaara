...
trait CharacterTrait {
	 ...
	 * @return string
	 */
	public static function cutstr(string $string = '', int $length = 9, string $haveDot = '',
		string $charset = 'utf8'): string {
	 ...
	 * @return string
	 */
	public static function xml_encode($data, string $encoding = 'utf-8', string $root = 'root', string $item = 'item',
