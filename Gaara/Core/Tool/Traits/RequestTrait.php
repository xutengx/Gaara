...
trait RequestTrait {
	 ...
	 */
	public static function asynExe(string $where = '', array $pars = [], string $scheme = 'http',
		string $host = '127.0.0.1'): bool {
	 ...
	 * @throws \GuzzleHttp\Exception\GuzzleException
	 */
	public static function sendGet(string $url, array $data = []): string {
		$client   = new Client();
	 ...
	 * @throws \GuzzleHttp\Exception\GuzzleException
	 */
	public static function sendPost(string $url, array $data = []): string {
		$client   = new Client();
