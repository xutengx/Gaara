...
$.fn.extend({
    copy_base: function (obj, callback) {
        var clip = new ZeroClipboard(this, {
            moviePath: "Main/Views/include/swf/ZeroClipboard.swf"
        });
        obj = arguments[0] || null;
        if (typeof(obj) === "string") this.attr('data-clipboard-text', obj);
        else {
            if (!obj.jquery) obj = $(obj);
            this.attr('data-clipboard-target', obj.attr('id'));
        }
        callback = arguments[1] || function (client, args) {
                alert('复制"'+args.text+'"成功,请使用Ctrl+V使用!');
            };
